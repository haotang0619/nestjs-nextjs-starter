...
3. `/components`: Contains page related components.
4. `/constants`: Constant like enum, static value, status code, etc.
5. `/i18n`: Contains i18n files.
6. `/icon`: Contains icon components.
7. `/layouts`: Contains the layouts used by pages.
8. `/pages`: Contains Next.js pages.
9. `/public`: Static file serving.
10. `/query`: react-query related code.
11. `/services`: API related code.
12. `/theme`: MUI theme configuration.
